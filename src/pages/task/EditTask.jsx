...
import { editTaskApi, getTaskByIdApi, getUserForTaskAssigneesApi } from './service'
...
export default function EditTask() {
    ...
    const handleGetTaskById = async () => {
        ...
        if (res.success) {
            setFormData(prevData => ({
                ...
                assigneesId: res.data.assignees.id
            }))
        } else {
    ...
    const handleEditTask = async (event) => {
        ...
        if (validateAllFields()) {
            dispatch(setLoading())
            const res = await editTaskApi(formData)
            dispatch(clearLoading())
            if (res.success) {
